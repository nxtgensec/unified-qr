  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-hero font-bold leading-none tracking-tight text-foreground">404</h1>
        <h2 className="mt-4 text-h2 font-semibold text-foreground">Page not found</h2>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Unified QR" },
      { name: "description", content: "One place for every QR code job." },
